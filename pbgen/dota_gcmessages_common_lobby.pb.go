...
func (CSODOTALobby_State) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{11, 0}
}
...
func (CSODOTALobby_LobbyType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{11, 1}
}
...
type CMsgLobbyCoachFriendRequest struct {
	...
	RequestState    *ELobbyMemberCoachRequestState `protobuf:"varint,3,opt,name=request_state,json=requestState,enum=protos.ELobbyMemberCoachRequestState,def=0" json:"request_state,omitempty"`
}
...
type CSODOTALobbyMember struct {
	...
	Team                   *DOTA_GC_TEAM            `protobuf:"varint,3,opt,name=team,enum=protos.DOTA_GC_TEAM,def=0" json:"team,omitempty"`
	...
	LeaverStatus           *DOTALeaverStatusT       `protobuf:"varint,16,opt,name=leaver_status,json=leaverStatus,enum=protos.DOTALeaverStatusT,def=0" json:"leaver_status,omitempty"`
	...
	CoachTeam              *DOTA_GC_TEAM            `protobuf:"varint,23,opt,name=coach_team,json=coachTeam,enum=protos.DOTA_GC_TEAM,def=5" json:"coach_team,omitempty"`
	...
	SearchMatchType        *MatchType               `protobuf:"varint,33,opt,name=search_match_type,json=searchMatchType,enum=protos.MatchType,def=0" json:"search_match_type,omitempty"`
	...
	LiveSpectatorTeam      *DOTA_GC_TEAM            `protobuf:"varint,40,opt,name=live_spectator_team,json=liveSpectatorTeam,enum=protos.DOTA_GC_TEAM,def=5" json:"live_spectator_team,omitempty"`
	...
	RankMmrBoostType       *EDOTAMMRBoostType       `protobuf:"varint,46,opt,name=rank_mmr_boost_type,json=rankMmrBoostType,enum=protos.EDOTAMMRBoostType,def=0" json:"rank_mmr_boost_type,omitempty"`
...
type CLobbyGuildDetails struct {
	...
	TeamForGuild          *DOTA_GC_TEAM `protobuf:"varint,9,opt,name=team_for_guild,json=teamForGuild,enum=protos.DOTA_GC_TEAM,def=0" json:"team_for_guild,omitempty"`
...
type CSODOTALobby struct {
	...
	State                                      *CSODOTALobby_State            `protobuf:"varint,4,opt,name=state,enum=protos.CSODOTALobby_State,def=0" json:"state,omitempty"`
	Connect                                    *string                        `protobuf:"bytes,5,opt,name=connect" json:"connect,omitempty"`
	LobbyType                                  *CSODOTALobby_LobbyType        `protobuf:"varint,12,opt,name=lobby_type,json=lobbyType,enum=protos.CSODOTALobby_LobbyType,def=-1" json:"lobby_type,omitempty"`
	...
	GameState                                  *DOTA_GameState                `protobuf:"varint,22,opt,name=game_state,json=gameState,enum=protos.DOTA_GameState,def=0" json:"game_state,omitempty"`
	...
	CmPick                                     *DOTA_CM_PICK                  `protobuf:"varint,28,opt,name=cm_pick,json=cmPick,enum=protos.DOTA_CM_PICK,def=0" json:"cm_pick,omitempty"`
	...
	BotDifficultyRadiant                       *DOTABotDifficulty             `protobuf:"varint,36,opt,name=bot_difficulty_radiant,json=botDifficultyRadiant,enum=protos.DOTABotDifficulty,def=3" json:"bot_difficulty_radiant,omitempty"`
	GameVersion                                *DOTAGameVersion               `protobuf:"varint,37,opt,name=game_version,json=gameVersion,enum=protos.DOTAGameVersion,def=0" json:"game_version,omitempty"`
	...
	DotaTvDelay                                *LobbyDotaTVDelay              `protobuf:"varint,53,opt,name=dota_tv_delay,json=dotaTvDelay,enum=protos.LobbyDotaTVDelay,def=0" json:"dota_tv_delay,omitempty"`
	...
	MatchOutcome                               *EMatchOutcome                 `protobuf:"varint,70,opt,name=match_outcome,json=matchOutcome,enum=protos.EMatchOutcome,def=0" json:"match_outcome,omitempty"`
	...
	Visibility                                 *DOTALobbyVisibility           `protobuf:"varint,75,opt,name=visibility,enum=protos.DOTALobbyVisibility,def=0" json:"visibility,omitempty"`
	...
	PauseSetting                               *LobbyDotaPauseSetting         `protobuf:"varint,88,opt,name=pause_setting,json=pauseSetting,enum=protos.LobbyDotaPauseSetting,def=0" json:"pause_setting,omitempty"`
	...
	BotDifficultyDire                          *DOTABotDifficulty             `protobuf:"varint,93,opt,name=bot_difficulty_dire,json=botDifficultyDire,enum=protos.DOTABotDifficulty,def=3" json:"bot_difficulty_dire,omitempty"`
	...
	EventProgressionEnabled                    []EEvent                       `protobuf:"varint,96,rep,name=event_progression_enabled,json=eventProgressionEnabled,enum=protos.EEvent" json:"event_progression_enabled,omitempty"`
	SelectionPriorityRules                     *DOTASelectionPriorityRules    `protobuf:"varint,97,opt,name=selection_priority_rules,json=selectionPriorityRules,enum=protos.DOTASelectionPriorityRules,def=0" json:"selection_priority_rules,omitempty"`
	...
	SeriesCurrentPriorityTeamChoice            *DOTASelectionPriorityChoice   `protobuf:"varint,100,opt,name=series_current_priority_team_choice,json=seriesCurrentPriorityTeamChoice,enum=protos.DOTASelectionPriorityChoice,def=0" json:"series_current_priority_team_choice,omitempty"`
	SeriesCurrentNonPriorityTeamChoice         *DOTASelectionPriorityChoice   `protobuf:"varint,101,opt,name=series_current_non_priority_team_choice,json=seriesCurrentNonPriorityTeamChoice,enum=protos.DOTASelectionPriorityChoice,def=0" json:"series_current_non_priority_team_choice,omitempty"`
	...
	CurrentPrimaryEvent                        *EEvent                        `protobuf:"varint,103,opt,name=current_primary_event,json=currentPrimaryEvent,enum=protos.EEvent,def=0" json:"current_primary_event,omitempty"`
...
func (*CMsgLobbyEventPoints_ChatWheelMessageRange) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{2, 0}
}
...
func (*CMsgLobbyEventPoints_PingWheelMessageRange) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{2, 1}
}
...
func (*CMsgLobbyEventPoints_PeriodicResourceValues) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{2, 2}
}
...
func (*CMsgLobbyEventPoints_EventGameCustomActions) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{2, 3}
}
...
type CMsgLobbyEventPoints_AccountPoints struct {
	...
	ArcanaEventPeriodicResource    *CMsgLobbyEventPoints_PeriodicResourceValues   `protobuf:"bytes,29,opt,name=arcana_event_periodic_resource,json=arcanaEventPeriodicResource" json:"arcana_event_periodic_resource,omitempty"`
}
...
func (*CMsgLobbyEventPoints_AccountPoints) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{2, 4}
}
...
func (x *CMsgLobbyEventPoints_AccountPoints) GetArcanaEventPeriodicResource() *CMsgLobbyEventPoints_PeriodicResourceValues {
	if x != nil {
		return x.ArcanaEventPeriodicResource
	}
	return nil
}
...
var file_dota_gcmessages_common_lobby_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x1b, 0x43, 0x4d, 0x73, 0x67, 0x4c, 0x6f, 0x62, 0x62, 0x79,
	0x43, 0x6f, 0x61, 0x63, 0x68, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x28, 0x0a, 0x10, 0x63, 0x6f, 0x61, 0x63, 0x68, 0x5f, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x63, 0x6f,
	0x61, 0x63, 0x68, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11,
	...
	,
	...
	0x67, 0x65, 0x58, 0x70, 0x22, 0x8b, 0x0f, 0x0a, 0x14, 0x43, 0x4d, 0x73, 0x67, 0x4c, 0x6f, 0x62,
	...
	0x07, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x51, 0x0a, 0x0e, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x2a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x43, 0x4d, 0x73, 0x67, 0x4c, 0x6f,
	...
	,
	...
	0x05, 0x6f, 0x77, 0x6e, 0x65, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
	...
	0x74, 0x73, 0x4d, 0x61, 0x73, 0x6b, 0x12, 0x7e, 0x0a, 0x22, 0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b,
	0x65, 0x64, 0x5f, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x77, 0x68, 0x65, 0x65, 0x6c, 0x5f, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x0d, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x43, 0x4d, 0x73, 0x67,
	...
	0x52, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x12, 0x61, 0x0a, 0x16, 0x70, 0x6c, 0x75, 0x73, 0x5f, 0x73,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e,
	...
	0x61, 0x74, 0x61, 0x52, 0x14, 0x70, 0x6c, 0x75, 0x73, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x56, 0x0a, 0x0c, 0x77, 0x61, 0x67,
	0x65, 0x72, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x33, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x43, 0x4d, 0x73, 0x67, 0x4c, 0x6f, 0x62,
	...
	,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x71, 0x0a, 0x1a, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64,
	0x69, 0x63, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x5f, 0x61, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d,
	0x65, 0x6e, 0x74, 0x73, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x73, 0x2e, 0x43, 0x4d, 0x73, 0x67, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x45, 0x76, 0x65,
	...
	0x6a, 0x75, 0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x7e, 0x0a, 0x22, 0x75, 0x6e, 0x6c,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x65, 0x61, 0x6d, 0x49, 0x64, 0x22, 0xda, 0x0f, 0x0a, 0x12, 0x43, 0x53, 0x4f, 0x44,
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x68, 0x65, 0x72, 0x6f, 0x49, 0x64, 0x12, 0x40, 0x0a,
	0x04, 0x74, 0x65, 0x61, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x5f, 0x47, 0x43, 0x5f, 0x54, 0x45, 0x41,
	...
	,
	...
	,
	...
	0x73, 0x12, 0x59, 0x0a, 0x13, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x74, 0x61,
	0x74, 0x6f, 0x72, 0x5f, 0x74, 0x65, 0x61, 0x6d, 0x18, 0x28, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x5f, 0x47, 0x43, 0x5f,
	...
	,
	...
	0x56, 0x69, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x62, 0x0a, 0x13, 0x72, 0x61, 0x6e, 0x6b, 0x5f,
	0x6d, 0x6d, 0x72, 0x5f, 0x62, 0x6f, 0x6f, 0x73, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x2e,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x45, 0x44,
	...
	,
	...
	0x0c, 0x74, 0x65, 0x61, 0x6d, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x12, 0x0a,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x13, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x53, 0x65, 0x63,
	0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x67,
	0x75, 0x69, 0x6c, 0x64, 0x5f, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0c, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e,
	0x12, 0x1d, 0x0a, 0x0a, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x6c, 0x6f, 0x67, 0x6f, 0x18, 0x05,
	...
	,
	...
	0x75, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xb9, 0x03, 0x0a, 0x14, 0x43, 0x4c, 0x6f,
	...
	0x5f, 0x74, 0x52, 0x07, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x08, 0x65,
	...
	0x67, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x36, 0x0a, 0x17, 0x63,
	0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f,
	0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x63, 0x68,
	0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x53, 0x65, 0x72,
	0x69, 0x61, 0x6c, 0x12, 0x3d, 0x0a, 0x1b, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x50, 0x0a, 0x0a, 0x67,
	0x61, 0x6d, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x5f, 0x47, 0x61,
	0x6d, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x3a, 0x19, 0x44, 0x4f, 0x54, 0x41, 0x5f, 0x47, 0x41,
	0x4d, 0x45, 0x52, 0x55, 0x4c, 0x45, 0x53, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x4e,
	0x49, 0x54, 0x52, 0x09, 0x67, 0x61, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x25, 0x0a,
	...
	0x72, 0x6f, 0x75, 0x70, 0x12, 0x3d, 0x0a, 0x07, 0x63, 0x6d, 0x5f, 0x70, 0x69, 0x63, 0x6b, 0x18,
	0x1c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x44,
	0x4f, 0x54, 0x41, 0x5f, 0x43, 0x4d, 0x5f, 0x50, 0x49, 0x43, 0x4b, 0x3a, 0x0e, 0x44, 0x4f, 0x54,
	0x41, 0x5f, 0x43, 0x4d, 0x5f, 0x52, 0x41, 0x4e, 0x44, 0x4f, 0x4d, 0x52, 0x06, 0x63, 0x6d, 0x50,
	0x69, 0x63, 0x6b, 0x12, 0x28, 0x0a, 0x08, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18,
	0x1e, 0x20, 0x01, 0x28, 0x04, 0x42, 0x0d, 0x8a, 0xb5, 0x18, 0x09, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x49, 0x44, 0x5f, 0x74, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x12, 0x2f, 0x0a,
	...
	,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x52, 0x0a, 0x14, 0x74, 0x69, 0x6d, 0x65, 0x64, 0x5f,
	0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x26,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x43, 0x4c,
	...
	,
	...
	,
	...
	0x42, 0x6c, 0x6f, 0x6f, 0x64, 0x48, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x65, 0x64, 0x12, 0x53, 0x0a,
	0x0d, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6f, 0x75, 0x74, 0x63, 0x6f, 0x6d, 0x65, 0x18, 0x46,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x45, 0x4d,
	...
	0x74, 0x6f, 0x6d, 0x4d, 0x61, 0x78, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x57, 0x0a,
	0x0a, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x4b, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x4c,
	0x6f, 0x62, 0x62, 0x79, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x3a, 0x1a,
	0x44, 0x4f, 0x54, 0x41, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c,
	0x69, 0x74, 0x79, 0x5f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x52, 0x0a, 0x76, 0x69, 0x73, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x54, 0x65, 0x61, 0x6d, 0x49, 0x64, 0x12, 0x98, 0x01, 0x0a, 0x23,
	...
	0x69, 0x63, 0x65, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x12, 0x9f, 0x01, 0x0a, 0x27, 0x73, 0x65, 0x72, 0x69, 0x65,
	...
	0x63, 0x65, 0x18, 0x65, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x73, 0x2e, 0x44, 0x4f, 0x54, 0x41, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50,
	...
	,
	...
	0x18, 0x69, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x18, 0x65, 0x6d, 0x65, 0x72, 0x67, 0x65, 0x6e, 0x63,
	...
	,
	...
	0x4e, 0x10, 0x06, 0x22, 0xa3, 0x02, 0x0a, 0x09, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x54, 0x79, 0x70,
	...
	0x41, 0x54, 0x43, 0x48, 0x10, 0x0c, 0x12, 0x0c, 0x0a, 0x08, 0x47, 0x41, 0x55, 0x4e, 0x54, 0x4c,
	0x45, 0x54, 0x10, 0x0d, 0x12, 0x13, 0x0a, 0x0f, 0x4e, 0x45, 0x57, 0x5f, 0x50, 0x4c, 0x41, 0x59,
	0x45, 0x52, 0x5f, 0x50, 0x4f, 0x4f, 0x4c, 0x10, 0x0e, 0x22, 0x2e, 0x0a, 0x18, 0x43, 0x4d, 0x73,
	0x67, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x50, 0x6c, 0x61, 0x79, 0x74, 0x65, 0x73, 0x74, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6a, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6a, 0x73, 0x6f, 0x6e, 0x22, 0xa2, 0x03, 0x0a, 0x18, 0x43, 0x4d,
	0x73, 0x67, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x47, 0x75, 0x69,
	...
	,
...
var file_dota_gcmessages_common_lobby_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_dota_gcmessages_common_lobby_proto_goTypes = []interface{}{
	(ELobbyMemberCoachRequestState)(0),                    // 0: protos.ELobbyMemberCoachRequestState
	(LobbyDotaTVDelay)(0),                                 // 1: protos.LobbyDotaTVDelay
	(LobbyDotaPauseSetting)(0),                            // 2: protos.LobbyDotaPauseSetting
	(CSODOTALobby_State)(0),                               // 3: protos.CSODOTALobby.State
	(CSODOTALobby_LobbyType)(0),                           // 4: protos.CSODOTALobby.LobbyType
	(*CMsgLobbyCoachFriendRequest)(nil),                   // 5: protos.CMsgLobbyCoachFriendRequest
	(*CMsgLobbyPlayerPlusSubscriptionData)(nil),           // 6: protos.CMsgLobbyPlayerPlusSubscriptionData
	(*CMsgLobbyEventPoints)(nil),                          // 7: protos.CMsgLobbyEventPoints
	(*CMsgLobbyEventGameData)(nil),                        // 8: protos.CMsgLobbyEventGameData
	(*CSODOTALobbyInvite)(nil),                            // 9: protos.CSODOTALobbyInvite
	(*CSODOTALobbyMember)(nil),                            // 10: protos.CSODOTALobbyMember
	(*CLobbyTeamDetails)(nil),                             // 11: protos.CLobbyTeamDetails
	(*CLobbyGuildDetails)(nil),                            // 12: protos.CLobbyGuildDetails
	(*CLobbyTimedRewardDetails)(nil),                      // 13: protos.CLobbyTimedRewardDetails
	(*CLobbyBroadcastChannelInfo)(nil),                    // 14: protos.CLobbyBroadcastChannelInfo
	(*CLobbyGuildChallenge)(nil),                          // 15: protos.CLobbyGuildChallenge
	(*CSODOTALobby)(nil),                                  // 16: protos.CSODOTALobby
	(*CMsgLobbyPlaytestDetails)(nil),                      // 17: protos.CMsgLobbyPlaytestDetails
	(*CMsgLocalServerGuildData)(nil),                      // 18: protos.CMsgLocalServerGuildData
	(*CMsgLocalServerFakeLobbyData)(nil),                  // 19: protos.CMsgLocalServerFakeLobbyData
	(*CMsgLobbyPlayerPlusSubscriptionData_HeroBadge)(nil), // 20: protos.CMsgLobbyPlayerPlusSubscriptionData.HeroBadge
	(*CMsgLobbyEventPoints_ChatWheelMessageRange)(nil),    // 21: protos.CMsgLobbyEventPoints.ChatWheelMessageRange
	(*CMsgLobbyEventPoints_PingWheelMessageRange)(nil),    // 22: protos.CMsgLobbyEventPoints.PingWheelMessageRange
	(*CMsgLobbyEventPoints_PeriodicResourceValues)(nil),   // 23: protos.CMsgLobbyEventPoints.PeriodicResourceValues
	(*CMsgLobbyEventPoints_EventGameCustomActions)(nil),   // 24: protos.CMsgLobbyEventPoints.EventGameCustomActions
	(*CMsgLobbyEventPoints_AccountPoints)(nil),            // 25: protos.CMsgLobbyEventPoints.AccountPoints
	(*CSODOTALobbyInvite_LobbyMember)(nil),                // 26: protos.CSODOTALobbyInvite.LobbyMember
	(*CSODOTALobby_CExtraMsg)(nil),                        // 27: protos.CSODOTALobby.CExtraMsg
	(DOTA_GC_TEAM)(0),                                     // 28: protos.DOTA_GC_TEAM
	(DOTALeaverStatusT)(0),                                // 29: protos.DOTALeaverStatus_t
	(MatchType)(0),                                        // 30: protos.MatchType
	(*CMsgPendingEventAward)(nil),                         // 31: protos.CMsgPendingEventAward
	(EDOTAMMRBoostType)(0),                                // 32: protos.EDOTAMMRBoostType
	(EEvent)(0),                                           // 33: protos.EEvent
	(DOTA_GameState)(0),                                   // 34: protos.DOTA_GameState
	(DOTA_CM_PICK)(0),                                     // 35: protos.DOTA_CM_PICK
	(DOTABotDifficulty)(0),                                // 36: protos.DOTABotDifficulty
	(DOTAGameVersion)(0),                                  // 37: protos.DOTAGameVersion
	(*CDOTASaveGame)(nil),                                 // 38: protos.CDOTASaveGame
	(EMatchOutcome)(0),                                    // 39: protos.EMatchOutcome
	(DOTALobbyVisibility)(0),                              // 40: protos.DOTALobbyVisibility
	(DOTASelectionPriorityRules)(0),                       // 41: protos.DOTASelectionPriorityRules
	(DOTASelectionPriorityChoice)(0),                      // 42: protos.DOTASelectionPriorityChoice
}
var file_dota_gcmessages_common_lobby_proto_depIdxs = []int32{
	0,  // 0: protos.CMsgLobbyCoachFriendRequest.request_state:type_name -> protos.ELobbyMemberCoachRequestState
	20, // 1: protos.CMsgLobbyPlayerPlusSubscriptionData.hero_badges:type_name -> protos.CMsgLobbyPlayerPlusSubscriptionData.HeroBadge
	25, // 2: protos.CMsgLobbyEventPoints.account_points:type_name -> protos.CMsgLobbyEventPoints.AccountPoints
	26, // 3: protos.CSODOTALobbyInvite.members:type_name -> protos.CSODOTALobbyInvite.LobbyMember
	28, // 4: protos.CSODOTALobbyMember.team:type_name -> protos.DOTA_GC_TEAM
	29, // 5: protos.CSODOTALobbyMember.leaver_status:type_name -> protos.DOTALeaverStatus_t
	28, // 6: protos.CSODOTALobbyMember.coach_team:type_name -> protos.DOTA_GC_TEAM
	30, // 7: protos.CSODOTALobbyMember.search_match_type:type_name -> protos.MatchType
	28, // 8: protos.CSODOTALobbyMember.live_spectator_team:type_name -> protos.DOTA_GC_TEAM
	31, // 9: protos.CSODOTALobbyMember.pending_awards:type_name -> protos.CMsgPendingEventAward
	31, // 10: protos.CSODOTALobbyMember.pending_awards_on_victory:type_name -> protos.CMsgPendingEventAward
	32, // 11: protos.CSODOTALobbyMember.rank_mmr_boost_type:type_name -> protos.EDOTAMMRBoostType
	28, // 12: protos.CLobbyGuildDetails.team_for_guild:type_name -> protos.DOTA_GC_TEAM
	33, // 13: protos.CLobbyGuildChallenge.event_id:type_name -> protos.EEvent
	10, // 14: protos.CSODOTALobby.v2_members:type_name -> protos.CSODOTALobbyMember
	10, // 15: protos.CSODOTALobby.v2_left_members:type_name -> protos.CSODOTALobbyMember
	10, // 16: protos.CSODOTALobby.all_members:type_name -> protos.CSODOTALobbyMember
	3,  // 17: protos.CSODOTALobby.state:type_name -> protos.CSODOTALobby.State
	4,  // 18: protos.CSODOTALobby.lobby_type:type_name -> protos.CSODOTALobby.LobbyType
	11, // 19: protos.CSODOTALobby.team_details:type_name -> protos.CLobbyTeamDetails
	34, // 20: protos.CSODOTALobby.game_state:type_name -> protos.DOTA_GameState
	35, // 21: protos.CSODOTALobby.cm_pick:type_name -> protos.DOTA_CM_PICK
	36, // 22: protos.CSODOTALobby.bot_difficulty_radiant:type_name -> protos.DOTABotDifficulty
	37, // 23: protos.CSODOTALobby.game_version:type_name -> protos.DOTAGameVersion
	13, // 24: protos.CSODOTALobby.timed_reward_details:type_name -> protos.CLobbyTimedRewardDetails
	1,  // 25: protos.CSODOTALobby.dota_tv_delay:type_name -> protos.LobbyDotaTVDelay
	14, // 26: protos.CSODOTALobby.broadcast_channel_info:type_name -> protos.CLobbyBroadcastChannelInfo
	27, // 27: protos.CSODOTALobby.extra_messages:type_name -> protos.CSODOTALobby.CExtraMsg
	38, // 28: protos.CSODOTALobby.save_game:type_name -> protos.CDOTASaveGame
	39, // 29: protos.CSODOTALobby.match_outcome:type_name -> protos.EMatchOutcome
	40, // 30: protos.CSODOTALobby.visibility:type_name -> protos.DOTALobbyVisibility
	2,  // 31: protos.CSODOTALobby.pause_setting:type_name -> protos.LobbyDotaPauseSetting
	36, // 32: protos.CSODOTALobby.bot_difficulty_dire:type_name -> protos.DOTABotDifficulty
	33, // 33: protos.CSODOTALobby.event_progression_enabled:type_name -> protos.EEvent
	41, // 34: protos.CSODOTALobby.selection_priority_rules:type_name -> protos.DOTASelectionPriorityRules
	42, // 35: protos.CSODOTALobby.series_current_priority_team_choice:type_name -> protos.DOTASelectionPriorityChoice
	42, // 36: protos.CSODOTALobby.series_current_non_priority_team_choice:type_name -> protos.DOTASelectionPriorityChoice
	33, // 37: protos.CSODOTALobby.current_primary_event:type_name -> protos.EEvent
	15, // 38: protos.CSODOTALobby.guild_challenges:type_name -> protos.CLobbyGuildChallenge
	12, // 39: protos.CSODOTALobby.guild_details:type_name -> protos.CLobbyGuildDetails
	7,  // 40: protos.CSODOTALobby.lobby_event_points:type_name -> protos.CMsgLobbyEventPoints
	5,  // 41: protos.CSODOTALobby.coach_friend_requests:type_name -> protos.CMsgLobbyCoachFriendRequest
	33, // 42: protos.CMsgLocalServerGuildData.event_id:type_name -> protos.EEvent
	7,  // 43: protos.CMsgLocalServerFakeLobbyData.event_points:type_name -> protos.CMsgLobbyEventPoints
	18, // 44: protos.CMsgLocalServerFakeLobbyData.guild_info:type_name -> protos.CMsgLocalServerGuildData
	21, // 45: protos.CMsgLobbyEventPoints.AccountPoints.unlocked_chat_wheel_message_ranges:type_name -> protos.CMsgLobbyEventPoints.ChatWheelMessageRange
	6,  // 46: protos.CMsgLobbyEventPoints.AccountPoints.plus_subscription_data:type_name -> protos.CMsgLobbyPlayerPlusSubscriptionData
	23, // 47: protos.CMsgLobbyEventPoints.AccountPoints.wager_tokens:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
	23, // 48: protos.CMsgLobbyEventPoints.AccountPoints.rank_wager_tokens:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
	23, // 49: protos.CMsgLobbyEventPoints.AccountPoints.tip_tokens:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
	23, // 50: protos.CMsgLobbyEventPoints.AccountPoints.periodic_point_adjustments:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
	22, // 51: protos.CMsgLobbyEventPoints.AccountPoints.unlocked_ping_wheel_message_ranges:type_name -> protos.CMsgLobbyEventPoints.PingWheelMessageRange
	23, // 52: protos.CMsgLobbyEventPoints.AccountPoints.bounties:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
	24, // 53: protos.CMsgLobbyEventPoints.AccountPoints.event_game_custom_actions:type_name -> protos.CMsgLobbyEventPoints.EventGameCustomActions
	23, // 54: protos.CMsgLobbyEventPoints.AccountPoints.arcana_event_periodic_resource:type_name -> protos.CMsgLobbyEventPoints.PeriodicResourceValues
